...
{{macros.collapsed_details('Make/Compose Bridge', level='h3')}}
...
{{macros.collapsed_details('Dynamic API', level='h3')}}
...
{{macros.collapsed_details('Make/Compose Bridge with k8s-tools.yml', level='h3')}}
